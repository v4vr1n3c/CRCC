...
const TRANSLATIONS = {
  pt: {
    ...
    register_error_too_many: 'Muitas tentativas de cadastro. Tente novamente em 1 hora.',
    error_server: 'Erro de conexão. Verifique se o servidor está disponível.',
    logout_btn: 'Sair',
    welcome_user: 'Olá,',
    // Admin
  ...
  en: {
    ...
    register_error_too_many: 'Too many registration attempts. Try again in 1 hour.',
    error_server: 'Connection error. Please check server availability.',
    logout_btn: 'Logout',
    welcome_user: 'Hello,',
  ...
  es: {
    ...
    register_error_too_many: 'Demasiados intentos de registro. Intente en 1 hora.',
    error_server: 'Error de conexión. Verifique la disponibilidad del servidor.',
